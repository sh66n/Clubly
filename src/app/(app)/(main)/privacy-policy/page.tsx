...
export default function PrivacyPolicy() {
  return (
    <div>
      ...
      <div>
        This privacy policy sets out how SHAAN SAMEER EDROOS uses and protects
        any information that you give SHAAN SAMEER EDROOS when you visit their
        website and/or agree to purchase from them. SHAAN SAMEER EDROOS is
        ...
        accordance with this privacy statement. SHAAN SAMEER EDROOS may change
        ...
        preferences and interests, if required Other information relevant to
        customer surveys and/or offers What we do with the information we gather
        ...
        interests. We are committed to ensuring that your information is secure.
        In order to prevent unauthorised access or disclosure we have put in
        suitable measures. How we use cookies A cookie is a small file which
        asks permission to be placed on your computer's hard drive. Once you
        agree, the file is added and the cookie helps analyze web traffic or
        ...
        cookies to identify which pages are being used. This helps us analyze
        data about webpage traffic and improve our website in order to tailor it
        to customer needs. We only use this information for statistical analysis
        purposes and then the data is removed from the system. Overall, cookies
        help us provide you with a better website, by enabling us to monitor
        which pages you find useful and which you do not. A cookie in no way
        gives us access to your computer or any information about you, other
        than the data you choose to share with us. You can choose to accept or
        ...
        to be used by anybody for direct marketing purposes if you have
        ...
        or emailing us at shaanedroos85@gmail.com We will not sell, distribute
        ...
        you is incorrect or incomplete, please write to Lok Udyan, Near Raheja
        Kalyan MAHARASHTRA 421301 . or contact us at 7208714123 or
        shaanedroos85@gmail.com as soon as possible. We will promptly correct
